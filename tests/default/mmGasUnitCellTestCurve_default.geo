...
hp_0 = 0.030;                                    // half pitch of the window, in mm
hp = 0.030 * mm - 0*r_w/mwf * mm;                // half pitch of the window, in microns
...
x1_sp_wind_fac2 = p*0.01;
x2_sp_wind_fac2 = p*0.01;
y1_sp_wind_fac2 = p*0.01;
y2_sp_wind_fac2 = p*0.01;
...
tmpb_1_1b[] = Extrude {{0,0,0},{0,1,0},{-p-sp_fac,-p,-Rtn+r_w}, alpha} {
  Surface{tmpb_1_1a[0]}; 
};
...
tmpb_1_2b[] = Extrude {x1_sp_wind_fac,0,0} {
  Surface{tmpb_1_2a[0]};
};

tmpb_1_2c[] = Extrude {{0,0,0},{0,-1,0},{p+sp_fac,-p,Rtp-r_w}, alpha} {
  Surface{tmpb_1_2b[0]}; 
};
...
tmpa_2_1b[] = Extrude {{0,0,0},{-1,0,0},{p,p+sp_fac,Rtp-r_w}, alpha} {
  Surface{tmpa_2_1a[0]};
};
...
tmpa_2_2b[] = Extrude {{0,0,0},{1,0,0},{p,-p-sp_fac,-Rtn+r_w}, alpha} {
  Surface{tmpa_2_2a[0]}; 
};
...
tmpa_1_1b[] = Extrude {{0,0,0},{0,-1,0},{p+sp_fac,p,-Rtn+r_w}, alpha} {
  Surface{tmpa_1_1a[0]};
};
...
tmpa_1_2b[] = Extrude {{0,0,0},{0,1,0},{-p-sp_fac,p,Rtp-r_w}, alpha} {
  Surface{tmpa_1_2a[0]};
};
...
tmpb_2_1b[] = Extrude {{0,0,0},{1,0,0},{-p,-p-sp_fac,Rtp-r_w}, alpha} {
  Surface{tmpb_2_1a[0]};  
};
...
tmpb_2_2b[] = Extrude {{0,0,0},{-1,0,0},{-p,p+sp_fac,-Rtn+r_w}, alpha} {
  Surface{tmpb_2_2a[0]}; 
};
