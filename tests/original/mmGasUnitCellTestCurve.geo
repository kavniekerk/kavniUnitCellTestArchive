...
mesh_level = 0.125;                               // mesh level, in mm
...
pb0_1 = newp; Point(pb0_1) = {-p+p,-p+p,r_w+mesh_level*mm, LcWiremesh * mm};                                                // centre circle
pb1_1_1 = newp; Point(pb1_1_1) = {-p+p,-p+p,0+mesh_level*mm, LcWiremesh * mm};                                              // bottom circle
pb2_1 = newp; Point(pb2_1) = {-p+p,-p+p+r_w,r_w+mesh_level*mm, LcWiremesh * mm};                                            // right circle
pb1_3_1 = newp; Point(pb1_3_1) = {-p+p,-p+p,2*r_w+mesh_level*mm, LcWiremesh * mm};                                          // top circle
// pb4_1 = newp; Point(pb4_1) = {-p+p,-p+p-r_w,r_w+mesh_level*mm, LcWiremesh * mm};                                         // left circle

lb1_1 = newl; Circle(lb1_1) = {pb1_1_1, pb0_1, pb2_1};
lb2_1 = newl; Circle(lb2_1) = {pb2_1, pb0_1, pb1_3_1};
lbs2_1 = newl; Line(lbs2_1) = {pb1_1_1, pb1_3_1};

llb1_1 = newll; Line Loop(llb1_1) = {lb1_1, lb2_1, -lbs2_1};

sb_1_1 = news; Plane Surface(sb_1_1) = {llb1_1};

tmpba_1_1[] = {sb_1_1};
sbaf_1_1_1[] = tmpba_1_1[0];

tmpbb_1_1[] = Extrude {x1_sp_wind_fac,0,0} {
  Surface{tmpba_1_1[0]};
};
...
tmpbc_1_1[] = Extrude {{x1_sp_wind_fac2,0,0},{0,1,0},{-p+p+1*sp_fac1,-p+p,-Rtn+r_w+mesh_level*mm}, alpha} {
  Surface{tmpbb_1_1[0]}; 
};
...
tmpbb_1_2[] = Extrude {{x1_sp_wind_fac2,0,0},{0,-1,0},{p+p+1*sp_fac1,-p+p,Rtp-r_w+mesh_level*mm}, alpha} {
  Surface{tmpba_1_2[0]}; 
};
...
tmpbc_1_2[] = Extrude {x1_sp_wind_fac,0,0} {
  Surface{tmpbb_1_2[0]};
};
...
pa0_2 = newp; Point(pa0_2) = {p+p+2*sp_fac1,p+p+2*sp_fac1,-r_w+mesh_level*mm, LcWiremesh * mm};                             // centre circle
pa2_1_1 = newp; Point(pa2_1_1) = {p+p+2*sp_fac1,p+p+2*sp_fac1,-2*r_w+mesh_level*mm, LcWiremesh * mm};                       // bottom circle
// pa2_2 = newp; Point(pa2_2) = {p+p+2*sp_fac1+r_w,p+p+2*sp_fac1,-r_w+mesh_level*mm, LcWiremesh * mm};                      // right circle
pa2_3_1 = newp; Point(pa2_3_1) = {p+p+2*sp_fac1,p+p+2*sp_fac1,0+mesh_level*mm, LcWiremesh * mm};                            // top circle
pa4_2 = newp; Point(pa4_2) = {p+p+2*sp_fac1-r_w,p+p+2*sp_fac1,-r_w+mesh_level*mm, LcWiremesh * mm};                         // left circle

las2_2 = newl; Line(las2_2) = {pa2_1_1, pa2_3_1};
la3_2 = newl; Circle(la3_2) = {pa2_3_1, pa0_2, pa4_2};
la4_2 = newl; Circle(la4_2) = {pa4_2, pa0_2, pa2_1_1};

lla1_2 = newll; Line Loop(lla1_2) = {la3_2, la4_2, las2_2};

sa_1_2 = news; Plane Surface(sa_1_2) = {lla1_2};

tmpaa_2_1[] = {sa_1_2};
saaf_1_2_1[] = tmpaa_2_1[0];

tmpab_2_1[] = Extrude {0,-y1_sp_wind_fac,0} {
  Surface{tmpaa_2_1[0]};
};
...
tmpac_2_1[] = Extrude {{0,y1_sp_wind_fac2,0},{-1,0,0},{p+p+1*sp_fac1,p+p+1*sp_fac1,Rtp-r_w+mesh_level*mm}, alpha} {
  Surface{tmpab_2_1[0]};
};
...
tmpab_2_2[] = Extrude {{0,y1_sp_wind_fac2,0},{1,0,0},{p+p+1*sp_fac1,-p+p+1*sp_fac1,-Rtn+r_w+mesh_level*mm}, alpha} {
  Surface{tmpaa_2_2[0]}; 
};
...
tmpac_2_2[] = Extrude {0,-y1_sp_wind_fac,0} {
  Surface{tmpab_2_2[0]};
};
...
pa0_1 = newp; Point(pa0_1) = {p+p+2*sp_fac1,p+p+2*sp_fac1,r_w+mesh_level*mm, LcWiremesh * mm};                              // centre circle
pa1_1_1 = newp; Point(pa1_1_1) = {p+p+2*sp_fac1,p+p+2*sp_fac1,0+mesh_level*mm, LcWiremesh * mm};                            // bottom circle
// pa2_1 = newp; Point(pa2_1) = {p+p+2*sp_fac1,p+p+2*sp_fac1+r_w,r_w+mesh_level*mm, LcWiremesh * mm};                       // right circle
pa1_3_1 = newp; Point(pa1_3_1) = {p+p+2*sp_fac1,p+p+2*sp_fac1,2*r_w+mesh_level*mm, LcWiremesh * mm};                        // top circle
pa4_1 = newp; Point(pa4_1) = {p+p+2*sp_fac1,p+p+2*sp_fac1-r_w,r_w+mesh_level*mm, LcWiremesh * mm};                          // left circle

las2_1 = newl; Line(las2_1) = {pa1_1_1, pa1_3_1};
la3_1 = newl; Circle(la3_1) = {pa1_3_1, pa0_1, pa4_1};
la4_1 = newl; Circle(la4_1) = {pa4_1, pa0_1, pa1_1_1};

lla1_1 = newll; Line Loop(lla1_1) = {la3_1, la4_1, las2_1};

sa_1_1 = news; Plane Surface(sa_1_1) = {lla1_1};

tmpaa_1_1[] = {sa_1_1};
saaf_1_1_1[] = tmpaa_1_1[0];

tmpab_1_1[] = Extrude {-x2_sp_wind_fac,0,0} {
  Surface{tmpaa_1_1[0]};
};
...
tmpac_1_1[] = Extrude {{x2_sp_wind_fac2,0,0},{0,-1,0},{p+p+1*sp_fac1,p+p+1*sp_fac1,-Rtn+r_w+mesh_level*mm}, alpha} {
  Surface{tmpab_1_1[0]};
};
...
tmpab_1_2[] = Extrude {{x2_sp_wind_fac2,0,0},{0,1,0},{-p+p+1*sp_fac1,p+p+1*sp_fac1,Rtp-r_w+mesh_level*mm}, alpha} {
  Surface{tmpaa_1_2[0]};
};
...
tmpac_1_2[] = Extrude {-x2_sp_wind_fac,0,0} {
  Surface{tmpab_1_2[0]};
};
...
pb0_2 = newp; Point(pb0_2) = {-p+p,-p+p,-r_w+mesh_level*mm, LcWiremesh * mm};                                               // centre circle
pb2_1_1 = newp; Point(pb2_1_1) = {-p+p,-p+p,-2*r_w+mesh_level*mm, LcWiremesh * mm};                                         // bottom circle
pb2_2 = newp; Point(pb2_2) = {-p+p+r_w,-p+p,-r_w+mesh_level*mm, LcWiremesh * mm};                                           // right circle
pb2_3_1 = newp; Point(pb2_3_1) = {-p+p,-p+p,0+mesh_level*mm, LcWiremesh * mm};                                              // top circle
// pb4_2 = newp; Point(pb4_2) = {-p+p-r_w,-p+p,-r_w+mesh_level*mm, LcWiremesh * mm};                                        // left circle

lb1_2 = newl; Circle(lb1_2) = {pb2_1_1, pb0_2, pb2_2};
lb2_2 = newl; Circle(lb2_2) = {pb2_2, pb0_2, pb2_3_1};
lbs2_2 = newl; Line(lbs2_2) = {pb2_1_1, pb2_3_1};

llb1_2 = newll; Line Loop(llb1_2) = {lb1_2, lb2_2, -lbs2_2};

sb_1_2 = news; Plane Surface(sb_1_2) = {llb1_2};

tmpba_2_1[] = {sb_1_2};
sbaf_1_2_1[] = tmpba_2_1[0];

tmpbb_2_1[] = Extrude {0,y2_sp_wind_fac,0} {
  Surface{tmpba_2_1[0]};
};
...
tmpbc_2_1[] = Extrude {{0,y2_sp_wind_fac2,0},{1,0,0},{-p+p,-p+p+1*sp_fac1,Rtp-r_w+mesh_level*mm}, alpha} {
  Surface{tmpbb_2_1[0]};  
};
...
tmpbb_2_2[] = Extrude {{0,y2_sp_wind_fac2,0},{-1,0,0},{-p+p,p+p+1*sp_fac1,-Rtn+r_w+mesh_level*mm}, alpha} {
  Surface{tmpba_2_2[0]}; 
};
...
tmpbc_2_2[] = Extrude {0,y2_sp_wind_fac,0} {
  Surface{tmpbb_2_2[0]};
};
