...
sl_wire_exterior_surface_1b[] = newreg; Surface Loop(sl_wire_exterior_surface_1b) = { -s_1_1b1[0], sb_1_1b[0], sb_1_1b[1], sb_1_1b[2], sb_1_1c[0], sb_1_1c[1], sb_1_1c[2], sb_1_2b[0], sb_1_2b[1], sb_1_2b[2], sb_1_2c[0], sb_1_2c[1], sb_1_2c[2], s_1_1b2[0] };
// vol_1b_wire = newreg; Volume(vol_1b_wire) = { tmpb_1_1b[1], tmpb_1_1c[1], tmpb_1_2b[1], tmpb_1_2c[1] };
...
physsurf_1b_wire = newreg; Physical Surface(physsurf_1b_wire) = { s_1_1b1[], sb_1_1b[], sb_1_1c[], sb_1_2b[], sb_1_2c[], s_1_1b2[] };
...
sl_wire_exterior_surface_2a[] = newreg; Surface Loop(sl_wire_exterior_surface_2a) = { -s_1_2a1[0], sa_2_1b[], sa_2_1c[], sa_2_2b[], sa_2_2c[], s_1_2a2[0] };
// vol_2a_wire = newreg; Volume(vol_2a_wire) = { tmpa_2_1b[1], tmpa_2_1c[1], tmpa_2_2b[1], tmpa_2_2c[1] };
...
sl_wire_exterior_surface_2b[] = newreg; Surface Loop(sl_wire_exterior_surface_2b) = { -s_1_2b1[0], sb_2_1b[], sb_2_1c[], sb_2_2b[], sb_2_2c[], s_1_2b2[0] };
// vol_2b_wire = newreg; Volume(vol_2b_wire) = { tmpb_2_1b[1], tmpb_2_1c[1], tmpb_2_2b[1], tmpb_2_2c[1] };
