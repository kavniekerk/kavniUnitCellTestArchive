...
sl_wire_exterior_surface_1a[] = newreg; Surface Loop(sl_wire_exterior_surface_1a) = { s_1_1a1[0], sa_1_1[], sa_1_2[], s_1_1a2[0] }; // sa_1_1[], sa_1_2[]
// vol_1a_wire = newv; Compound Volume(vol_1a_wire) = { tmpa_1_1[1], tmpa_1_2[1] }; // tmpa_1_1[1], tmpa_1_2[1]
...
physsurf_1a_wire = newreg; Physical Surface(physsurf_1a_wire) = { s_1_1a1, sa_1_1[], sa_1_2[], s_1_1a2 }; // sa_1_1[], sa_1_2[]
...
sl_wire_exterior_surface_1b[] = newreg; Surface Loop(sl_wire_exterior_surface_1b) = { s_1_1b1[0], sb_1_1[], sb_1_2[], s_1_1b2[0] }; // sb_1_1[], sb_1_2[],
// vol_1b_wire = newreg; Compound Volume(vol_1b_wire) = { tmpb_1_1[1], tmpb_1_2[1] }; // tmpb_1_1[1], tmpb_1_2[1]
...
physsurf_1b_wire = newreg; Physical Surface(physsurf_1b_wire) = { s_1_1b1[], sb_1_1[], sb_1_2[], s_1_1b2[] }; // sb_1_1[], sb_1_2[],
...
sl_wire_exterior_surface_2a[] = newreg; Surface Loop(sl_wire_exterior_surface_2a) = { s_1_2a1[0], sa_2_1[], sa_2_2[], s_1_2a2[0] }; // sa_2_1[], sa_2_2[]
// vol_2a_wire1 = newreg; Volume(vol_2a_wire1) = { tmpa_2_1[1], tmpa_2_2[1] }; // tmpa_2_1[1], tmpa_2_2[1]
// vol_2a_wire2 = newreg; Volume(vol_2a_wire2) = { tmpa_2_1[1], tmpa_2_2[1] }; // tmpa_2_1[1], tmpa_2_2[1]
...
physsurf_2a_wire = newreg; Physical Surface(physsurf_2a_wire) = { s_1_2a1[], sa_2_1[], sa_2_2[], s_1_2a2[] }; // sa_2_1[], sa_2_2[]
...
sl_wire_exterior_surface_2b[] = newreg; Surface Loop(sl_wire_exterior_surface_2b) = { s_1_2b1[0], sb_2_1[], sb_2_2[], s_1_2b2[0] }; // sb_2_1[], sb_2_2[]
// vol_2b_wire1 = newreg; Volume(vol_2b_wire1) = { tmpb_2_1[1], tmpb_2_2[1] }; // tmpb_2_1[1], tmpb_2_2[1]
// vol_2b_wire2 = newreg; Volume(vol_2b_wire2) = { tmpb_2_1[1], tmpb_2_2[1] }; // tmpb_2_1[1], tmpb_2_2[1]
...
physsurf_2b_wire = newreg; Physical Surface(physsurf_2b_wire) = { s_1_2b1[], sb_2_1[], sb_2_2[], s_1_2b2[] }; // sb_2_1[], sb_2_2[]
...
l2bdh_1_1_bsurft1 = newl; Line(l2bdh_1_1_bsurft1) = {pexet1, p2b_3_1};                             // top circle
l1bdh_1_1_bsurfb1 = newl; Line(l1bdh_1_1_bsurfb1) = {pc2_2, pbdhab_1_2_2[1]};                      // bottom line
l2bdh_1_1_bsurfb1 = newl; Line(l2bdh_1_1_bsurfb1) = {pc2_1, p1b_1_1};                              // bottom circle

llbdh_1_1_bsurf1t = newreg; Line Loop(llbdh_1_1_bsurf1t) = { lexet1, l1bdh_1_1_bsurft1, -ll_bdhbt_1_1_1[0], -ll_bdhbt_1_1_2[0], l1_2b, l2_2b, -l2bdh_1_1_bsurft1 };
...
l1bdh_1_2_bsurft1 = newl; Line(l1bdh_1_2_bsurft1) = {pexet4, p2a_3_1};                             // top line
l1bdh_1_2_bsurfb1 = newl; Line(l1bdh_1_2_bsurfb1) = {pc2_3, p1a_1_1};                              // bottom line
...
llbdh_2_2_bsurf6b = newreg; Line Loop(llbdh_2_2_bsurf6b) = { lcpbub4a, l2bdh_1_1_bsurfb1, l1_1b, l2_1b, ll_bdhbt_2_2_1[0], ll_bdhbt_2_2_2[0], -l1bdh_2_1_bsurfb4 };
